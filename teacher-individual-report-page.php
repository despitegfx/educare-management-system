...
?>
                  <tr>
                    ...
                    <td><?php echo $time; ?></td>
                    <td>
                      <a href="teacher-create-report-page.php?viewSingleReport=<?php echo $sql['id'];?>" class="btn btn-success"><span class="fa fa-eye"></a> 
                      
                      <a href="teacher-create-report-page.php?editSingleReport=<?php echo $sql['id']; ?>" class="btn btn-primary"><span class="fa fa-edit"></span></a> 

...
<div class="data-table-area mg-b-15" style="width: 90%; margin-right: auto; margin-left: auto;">
        ...
        <div class="container-fluid" style="margin-top: 20px;">
            <div  style="background: #2086d2; color:#ffff; height: 50px; border-bottom-left-radius: 
                ...
                <a href="teacher-page.php" style="color: yellow;"><span class="fa fa-arrow-left"></span></a>&nbsp&nbspMy Profile    
            </div>
        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6">
                                        <div class="address-hr tb-sm-res-d-n dps-tb-ntn">
                                            <p><b>Class Teaching</b><br><?php echo $rowsEdit['class']; ?></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                            ...
                                            <div class="review-content-section" >
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="form-group">
                                                            <lable>Class Teaching</lable>
                                                            <input type="text" class="form-control" disabled="" value="<?php echo $rowsEdit['class']; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="form-group">

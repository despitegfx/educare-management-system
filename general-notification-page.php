...
<?php if ($permission==false ):header("location:404.html"); endif;?>
        ...
        <!-- Static Table Start -->
<?php 
$select = "SELECT * FROM notification_data WHERE student_id=0";
...
?>
        ...
        <div class="data-table-area mg-b-15">
            <div class="container-fluid" style="margin-top: 20px;">
                ...
                <span class="fa fa-bell"></span> General Announcement &nbsp; <span style="font-size: 8pt; color:#255577 "><?php echo $sql['message_date']; ?></span>
                <!-- end -->
                        ...
                        <div class="sparkline8-list" style="border-bottom-width: 2px; border-bottom-color:#2086d2; border-bottom-style: solid;
                            ...
                            <div class="sparkline8-hd" >
                                <div class="main-sparkline8-hd" >
                                    <h1 style="color: #2086d2;"><?php echo $sql['subject']; ?></h1>
                                </div>

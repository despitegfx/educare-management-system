...
<?php 
$select = "SELECT id, sname, other_name FROM student WHERE class like '".$_SESSION['class']."' order by sname asc ";
$count = 0;
...
?>
                  <tr>
                    ...
                    <td><!-- <a href="teacher-individual-report-page.php?view=<?php echo $sql['id']; ?>" class="btn btn-primary"><span class="fa fa-folder"></span></a> --> <a href="teacher-class-report-page.php?create-class-report=<?php echo $sql['id']; ?>" class="btn btn-success"><span class="educate-icon educate-interface"></span>    Report</a></td>
                  </tr>

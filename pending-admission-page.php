...
<?php require_once "header.php" ?>
        ...
        <div class="data-table-area mg-b-15">
            ...
            <div class="container-fluid" style="margin-top: 20px;">
                <div  style="background: orange; color:#ffff; height: 50px; border-bottom-left-radius: 
                10px; border-bottom-right-radius: 
                10px; line-height: 50px; text-indent: 10px;">
                <a href="student-page.php" style="color: yellow;"><span class="fa fa-arrow-left"></span></a>
                <span class="fa fa-table"></span> Pending Admissions    
            </div>
                        ...
                        <div class="sparkline13-list" >
                            ...
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    <div id="toolbar">
                                      <!-- <a href="admission-page.php?id=0" class="btn btn-success">Pending Admissions</a> -->
                                    </div>
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true"  data-key-events="true" data-resizable="true"
                                        ...
                                        <tbody>
<?php 
$select = "SELECT * FROM admission_data WHERE admitted='no' ORDER BY joindate ";
$count = 0;
...
?>
                ...
                <?php endif; ?>
                    ...
                    <td><a href="admission-review-edit-page.php?review-admission=<?php echo $sql['id']; ?>" class="btn btn-primary"><span class="fa fa-eye"></span></a> <a href="pending-admission-page.php?pending-wipe=<?php echo $sql['id']; ?>" class="btn btn-danger"><span class="fa fa-trash"></span></a></td>

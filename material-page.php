...
?>
                  ...
                  echo "background:#FFE4E4;"; endif;?> ">
                    ...
                    <td><a href="add-take-material-page.php?addmaterial=<?php echo $sql['id']; ?>" class="btn btn-success"><span class="fa fa-plus"></span></a> <a href="add-take-material-page.php?takematerial=<?php echo $sql['id']; ?>" class="btn btn-danger"><span class="fa fa-minus"></span></a></td>
                  </tr>

...
<div class="data-table-area mg-b-15" style="width: 90%; margin-right: auto; margin-left: auto;">
            ...
            <div class="container-fluid" style="margin-top: 20px;">
                ...
                <span class="fa fa-table"></span> Fees   
            </div>
        ...
        <div class="data-table-area mg-b-15">
            <div class="container-fluid">
                ...
                <tbody>
                 ...
                 <?php 
 $select = "SELECT student.id, student.sname, student.other_name, bill.bill, bill.paid, bill.balance 
          FROM student 
          JOIN bill 
...
?>
                  ...
                  echo "background:#FFE4E4;"; endif;?> " >
                    ...
                    <td><a href="take-bill-page.php?takebill=<?php echo $sql['id']; ?>" class="btn btn-warning "><span class="fa fa-money"></span> Take Fee</a> <a href="individual-fee-page.php?view=<?php echo $sql['id']; ?>" class="btn btn-danger"><span class="fa fa-folder"></span></a></td>
                  </tr>

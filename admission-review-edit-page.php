        ...
        <div class="data-table-area mg-b-15" >
            ...
            <?php if ($edit == true):?>
               ...
               <a href="student-page.php" style="color: yellow;"><span class="fa fa-arrow-left"></span></a>
                <span class="fa fa-edit"></span> <?php echo $sname." ".$other_name; ?>  
                </div>
            <?php endif; ?>
            <?php if ($edit == false): ?>
                <div  style="background: #2086d2; color:#ffff; height: 50px; border-radius: 
                5px; line-height: 50px; text-indent: 10px; font-size: 14pt;">
               <a href="student-page.php" style="color: yellow;"><span class="fa fa-arrow-left"></span></a>
                <span class="fa fa-file"></span> Admission Form    
                </div>
            <?php endif; ?>
            ...
            <div id="myTabContent" class="tab-content custom-product-edit">
                ...
                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                    ...
                    <div class="form-group">
                        <img  width="130px" src="php/passport/<?php echo $image; ?>">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    ...
                    <?php if ($edit == false):?>                                       
                    <div class="form-group">
                        <label <?php if ($success==true): echo 'style="color:red;"'; endif ?>>Select Class*</label>
...
<!-- Emergency Details End-->
        ...
        <div class="container-fluid" style="margin-top: 10px; margin-bottom: 100px;">
            ...
            <?php if ($edit == false): ?>
                ...
                <button  class="btn btn-primary" type="submit" name="admit">Admit</button>
                <a href="student-page.php"  class="btn btn-warning"> Cancel</a>  

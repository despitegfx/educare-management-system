...
<div class="data-table-area mg-b-15" style="width: 90%; margin-right: auto; margin-left: auto;">
            ...
            <div class="container-fluid" style="margin-top: 20px;">
                <div  style="background: #000000; color:#ffff; height: 50px; border-bottom-left-radius:10px; border-bottom-right-radius: 10px; 
                line-height: 50px; text-indent: 10px;">
                <a href="attendance-page.php" style="color: yellow;"><span class="fa fa-arrow-left"></span></a>
                <span class="fa fa-child"></span> <?php echo $sname ." ".$other_name."'s"; ?>
                <em style="color: #2086d2;"> attendance</em>   
            </div>
        ...
        <div class="data-table-area mg-b-15">
            <div class="container-fluid">
                ...
                <tbody>
                  ...
                  <?php 
$select = "SELECT r.status,r.checked_by,r.date FROM attendance_records r WHERE student_id = '".$id."'";
$count = 0;
